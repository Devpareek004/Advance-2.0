...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6914788581 6515520140').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002369256270').split()] #Channel id for auto indexing ( make sure bot is admin )
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002407314810') #Channel / Group Id for force sub ( make sure bot is admin )
...
MSG_ALRT = environ.get('MSG_ALRT', 'How are you ❤️')
